...
namespace DataModels.ApplicationModels
{
    public class LanguageDataDTO
    {
        ...
        public ICollection<LanguageTestDTO> LanguageTests { get; set; }
        ...
        // Methods
        //join the second languages into a single string
        public IEnumerable<string> SecondLanguages { get; set; } = [];
        public void  JoinSecondLanguages()
        {
            SecondLanguage = string.Join(",", SecondLanguages);
        }
    }
}
